...
///import core/utils.js
     ...
     *  }
        ...
        /**
         * 为分素element绑定原生DOM事件，type为事件类型，handler为处理函数
         * @name on
         * @grammar UE.dom.domUtils.on(element,type,handler)   //type支持数组传入
         * @example
         * UE.dom.domUtils.on(document.body,"click",function(e){
     *     //e为事件对象，this为被点击分素对戏那个
     * })
         * @example
         * UE.dom.domUtils.on(document.body,["click","mousedown"],function(evt){
     *     //evt为事件对象，this为被点击分素对象
     * })
         */
        ...
        /**
         * 在分素element上删除classNames，支持同时删除多个
         * @name removeClasses
        ...
        /**
         * 在分素element上增加一个样式类className，支持以空格分开的多个类名
         * 如果相同的类名将不会添加
         * @name addClass
        ...
        /**
         * 判断分素element是否包含样式类名className,支持以空格分开的多个类名,多个类名顺序不同也可以比较
         * @name hasClass
...
///import core/dom/domUtils.js
    ...
    (function () {
        ...
        Range.prototype = {
            ...
            shrinkBoundary: function (ignoreEnd) {
                ...
                if (!ignoreEnd) {
                    while (me.endContainer.nodeType == 1//是element
                        && me.endOffset > 0 //如果是空分素就退出 endOffset=0那么endOffst-1为负值，childNodes[endOffset]报错
            ...
            /**
             * 获取当前range所在位置的公共祖先节点，当前range位置可以位于文本节点内，也可以包含整个分素节点，也可以位于两个节点之间
             * @name  getCommonAncestor
            ...
            /**
             * 对当前range选中的节点，去掉给定的标签节点，但标签中的内容保留，主要用于处理inline分素
            ...
            doParagraph = function (range, style, attrs, sourceCmdName) {
                ...
                while (current && !(domUtils.getPosition(current, bookmark2.end) & domUtils.POSITION_FOLLOWING)) {
                    if (current.nodeType == 3 || !block(current)) {
                        ...
                        //如果para上一级是一个block分素且不是body,td就删除它
...
///commandsDialog  dialogs\video
    ...
    (function () {
        ...
        /**
         * 获取单分格或者单分格组的“对齐”状态。 如果当前的检测对象是一个单分格组， 只有在满足所有单分格的 水平和竖直 对齐属性都相同的
         * 条件时才会返回其状态值，否则将返回null； 如果当前只检测了一个单分格， 则直接返回当前单分格的对齐状态；
         * @param table cell or table cells , 支持单个单分格dom对象 或者 单分格dom对象数组
        ...
        UETable.prototype = {
            ...
            /**
             * 获取相同结束位置的单分格，xOrY指代了是获取x轴相同还是y轴相同
             */
                    ...
                    for (var i = 0; i < this.rowsNum; i++) {
                        ...
                        for (var j = 0, tmpCell; tmpCell = cells[j++];) {
                            ...
                            if (cell == tmpCell || end == tmpEnd) {
                                //只获取单一的单分格
                                //todo 仅获取单一单分格在特定情况下会造成returns为空，从而影响后续的拖拽实现，修正这个。需考虑性能
            ...
            update: function (table) {
                ...
                for (var rowIndex = 0, row; row = rows[rowIndex]; rowIndex++) {
                    for (var cellIndex = 0, cell, cells = row.cells; cell = cells[cellIndex]; cellIndex++) {
                        ...
                        //当已经被上一行rowSpan或者被前一列colSpan了，则跳到下一个单分格进行
            ...
            insertRow: function (rowIndex, sourceCell) {
                ...
                if (rowIndex == 0 || rowIndex == this.rowsNum) {
                    ...
                    for (colIndex = 0; colIndex < numCols; colIndex++) {
                        ...
                        //如果存在某个单分格的rowspan穿过待插入行的位置，则修改该单分格的rowspan即可，无需插入单分格
    ...
    (function () {
        ...
        UE.commands['cellalignment'] = {
            ...
            /**
             * 查询当前点击的单分格的对齐状态， 如果当前已经选择了多个单分格， 则会返回所有单分格经过统一协调过后的状态
...
//        throw e;
        ...
        var startTd = null, //鼠标按下时的锚点td
            ...
            onBorder = false, //检测鼠标按下时是否处在单分格边缘位置
            dragButton = null,
            dragOver = false,
...
//                    });
        ...
        function tableClickHander(evt) {
            ...
            //trace:3113
            //选中单分格，点击table外部，不会清掉table上挂的ueTable,会引起getUETableBySelected方法返回值
...
//        var state = getRelation(startTd, mouseCoords(evt));
        ...
        /**
         * 获取调整单分格大小的相关单分格
         * @isContainMergeCell 返回的结果中是否包含发生合并后的单分格
         */
        ...
        function getTableCellOffset(cell) {
            ...
            if (tab.offsetVal === undefined) {
                ...
                if (prev) {
                    ...
                    //最后一个单分格和前一个单分格的width diff结果 如果恰好为一个border width， 则条件成立
...
///import uicore
    (function () {
        ...
        /**
         * 该参数将新增一个参数： selected， 参数类型为一个Object， 形如{ 'align': 'center', 'valign': 'top' }， 表示单分格的初始
