...
*/ 
    ...
    'WAITSEND'=>' AND (pay_status=1 OR pay_code="cod") AND shipping_status !=1 AND order_prom_type !=9 AND order_prom_type!=8 AND order_status in(0,1) ', //订单查询状态 待发货
    ...
    'DAISHOU'=> ' AND order_prom_type = 9 ', // 购买批发区商品冷冻状态的订单
...
//        '6'=>array('身份验证','尊敬的 ${user_name}用户，您的验证码为${code}, 本验证码有效时间为10分钟, 请勿告诉他人.','bind_mobile_sms_enable'),
        ...
        '3'=>array('客户下单','${user_name}您好，您在店消费${duoshaoyuan}元。','order_add_sms_enable'),
        '4'=>array('客户支付','订单:${order_sn}已经支付，请及时发货.','order_pay_sms_enable'),
        '5'=>array('商品发货','尊敬的${user_name}用户，您的订单${order_sn}已发货，收货人${consignee}，请您及时查收','order_shipping_sms_enable'),
