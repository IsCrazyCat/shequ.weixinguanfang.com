...
//        }
    ...
    /**
     * 商品评论列表 by lishibo 20190226
     * @return mixed
     * @throws \think\exception\DbException
     */
    public function goodscoments(){
    ...
    /*
     * ajax获取商品评论
     * 取前三条 update lishibo 20190226
     */
    public function ajaxComment_goodsinfo()
    {
        $goods_id = I("goods_id/d", 0);
     ...
     * @return mixed
     */
    public function ajaxComment_copy()
    {
        $goods_id = I("goods_id/d", 0);
        $commentType = I('commentType', '1'); // 1 全部 2好评 3 中评 4差评
        if ($commentType == 5) {
