...
class WechatLogic
{
    ...
    private function handleSubscribeEvent($msg)
    {
        ...
        //$wechatObj->sendMsg($openid, "欢迎来到我得三渔工坊! 商城入口：http://".$_SERVER['HTTP_HOST'].'/mobile/');
        $wechatObj->sendMsg($openid, "您好，欢迎来到社群新零售，需要免费领取支架或咨询其它问题请联系客服：0631-5757866   客服微信（鱼海）：15163100686");
        exit;
    }
    ...
    private function replyDefault($msg)
    {
        $fromUsername = $msg['FromUserName'];
        $toUsername   = $msg['ToUserName'];
        $content = '您好，欢迎来到社群新零售，需要免费领取支架或咨询其它问题请联系客服：0631-5757866   客服微信（鱼海）：15163100686';
