<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:43:"./template/mobile/new2/goods\goodsInfo.html";i:1566787521;s:41:"./template/mobile/new2/public\header.html";i:1566471081;s:42:"./template/mobile/new2/public\top_nav.html";i:1533297481;s:43:"./template/mobile/new2/public\wx_share.html";i:1558745778;s:49:"./template/mobile/new2/public\wx_share_index.html";i:1558682064;s:47:"./template/mobile/new2/public\wx_subscribe.html";i:1566263775;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
    <title>商品详情--社群新零售</title>
...
<div class="he_sustain" style="display:none;">
...
<div class="xq_details">
    <div class="banner ban1 detailban">
        <div class="mmslide" id="slideTpshop">
            <ul>
                <?php if(is_array($goods_images_list) || $goods_images_list instanceof \think\Collection || $goods_images_list instanceof \think\Paginator): if( count($goods_images_list)==0 ) : echo "" ;else: foreach($goods_images_list as $key=>$pic): ?>
                    <li><a href="javascript:void(0)"><img src="<?php echo $pic[image_url]; ?>" style="width:100%;height:auto;" alt=""></a></li>
    ...
    <script>
        $(function(){
            for(var i=0;i<3;i++){
                var ih = $("#slideTpshop>ul>li>a img").eq(0).height();
    ...
    <div class="de_font p">
        <div class="thirty">
            <div class="fl" style="padding-top:10px;padding-bottom:10px;">
                <span class="similar-product-text" style="font-size:0.8rem;font-weight: 400;"><?php echo $goods['goods_name']; ?></span>
            </div>

            <div class="keep fr" style="display:none;">
            ...
            <div class="scunde p">
              ...
              <!--     <p>市场价：<span class="linethr"><?php echo $goods['market_price']; ?></span></p>-->
                   <p class="red" id="shop_price" style="font-weight:500;font-size:0.9rem;">￥<?php echo $goods['shop_price']; ?>&nbsp;&nbsp;&nbsp;
                   </p>
                    <!--<p><span>首单瓶付后，重复消费立减20%，相当于8折优惠</span></p>-->

                <?php if($goods['cat_id'] == 4): ?>
                    <p >可用余额:<span style="color: red"><?php echo $xianshi; ?></span>元</p>
                <?php endif; ?>
                    <p><span>复购最高享有15%~23%返利</span></p>
...
<!--    <div class="myorder p seedeadei">
        ...
        <div class="myorder p tbv">
            <div class="content30">
                <a href="<?php echo U('Goods/goodscoments',array('id'=>$goods['goods_id'])); ?>">
                    <div class="order">
                        <div class="fl">
        ...
        <div class="xq_details">
           <div class="sg">
                <div class="spxq p" style="margin:0px;">
...
<!--底部按钮-s-->
    ...
    <div class="cart-concert-btm p">
       <!-- <div class="fl">
            <ul>
                <li>
                    &lt;!&ndash;<a href="tencent://message/?uin=<?php echo $tpshop_config['shop_info_qq']; ?>&Site=三渔工坊创业联盟商城&Menu=yes">&ndash;&gt;
        ...
        <div class="fr" style="width:100%;">
            <ul>
               <!-- <li class="o">
                ...
                <li class="r"  style="width:100%;background: #84BD00;">
                    <!--<a style="display:block;" href="javascript:void(0);"  onclick="AjaxAddCart(<?php echo $goods['goods_id']; ?>,1,1);">立即购买</a>-->
                    <a style="display:block;" href="javascript:void(0);"  id="choise_num">立即购买</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="maleri30">
                <div class="shopprice">
                    ...
                    <div class="fon_or fl">
                        ...
                        <?php if($goods['cat_id'] == 4): ?>
                        <div class="dqkc_or"><span>可用余额：</span><span id=""><?php echo $xianshi; ?>元</span></div>
                        <?php endif; ?>
...
<script type="text/javascript">
    ...
    function sel(){
        ...
        var num = $('.num').val();
        if(num > residuenum ){
            layer.open({content:'当前商品最多可购买'+residuenum+'瓶',time:2})
            num = residuenum;
        }
        var sel = title+'&nbsp;&nbsp;'+num+'瓶';
        $('.sel').html(sel);
...
$(document).ready(function(){
        ...
        function ajaxComment(commentType,page){
            $.ajax({
                type : "GET",
                url:"/index.php?m=Mobile&c=goods&a=ajaxComment_goodsinfo&goods_id=<?php echo $goods['goods_id']; ?>&commentType="+commentType+"&p="+page,//+tab,
                success: function(data){
