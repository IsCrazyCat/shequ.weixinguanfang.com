<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"./template/mobile/new2/cart\ajax_cart_list.html";i:1551270546;}*/ ?>
                ...
                <div class="deleshow fr">
                    ...
                    <div class="prices">
                        ...
                        <div class="plus fr get_mp">
                            ...
                            <span class="mp_mp">
                            <input id="goods_num[<?php echo $v['id']; ?>]" type="text" style="font-size:1rem; height:1rem;" onKeyDown='if(event.keyCode == 13) event.returnValue = false' name="goods_num[<?php echo $v['id']; ?>]"  value="<?php echo $v['goods_num']; ?>"  class="input-num"  onblur="switch_num(0,<?php echo $v['id']; ?>,<?php echo $v['store_count']; ?>)"/>
                            </span>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="foohi foohiext">
        <div class="payit ma-to-20 payallb">
            <div class="fl alllef" style="">
                <div class="radio fl" onclick="chkAll_onclick()" style="width:3rem;">
                    <span class="che alltoggle" style="display:inherit;">
                        <i style="margin-top:0.1rem;"></i>
                    </span>
                    <span class="all" style="line-height: 0.9rem;">全选</span>
                </div>
                <div class="youbia" style="width:7.2rem;">
                    <p style="line-height: 0.9rem;"><span class="pmo">总计：</span><span>￥</span><span id="cartsum"><?php echo $total_price['total_fee']; ?></span></p>
                    <p style="line-height: 0.9rem;" class="lastime"><span>不含运费</span></p>
                </div>
            </div>
            <div class="fr">
