<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:41:"./template/mobile/new2/user\userinfo.html";i:1564490498;s:41:"./template/mobile/new2/public\header.html";i:1566471081;s:45:"./template/mobile/new2/public\header_nav.html";i:1533297512;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
    <title>资料修改--社群新零售</title>
		...
		<div class="floor my p setting">
			<div class="content">
				<div class="floor list7">
					...
					<div class="myorder p">
						<div class="content30">
							<a href="<?php echo U('Mobile/User/userinfo',array('action'=>'shenfenzheng')); ?>">
								<div class="order">
									<div class="fl">
										<span>身份证号</span>
									</div>
									<div class="fr">
										<span><?php echo $user['shenfenzheng']; ?></span>
										<i class="Mright"></i>
									</div>
								</div>
							</a>
					...
					<div class="myorder p">
						<div class="content30">
							<a href="<?php echo U('Mobile/User/userinfo',array('action'=>'kaihuhang')); ?>">
								<div class="order">
									<div class="fl">
										<span>开户行</span>
									</div>
									<div class="fr">
										<span><?php echo $user['kaihuhang']; ?></span>
										<i class="Mright"></i>
									</div>
								</div>
							</a>
					...
					<div class="myorder p">
						<div class="content30">
							<a href="<?php echo U('Mobile/User/userinfo',array('action'=>'card_no')); ?>">
								<div class="order">
									<div class="fl">
										<span>银行卡号</span>
									</div>
									<div class="fr">
										<span><?php echo $user['card_no']; ?></span>
										<i class="Mright"></i>
									</div>
								</div>
							</a>
					...
					<div class="myorder p bo" style="display: none">
						<div class="content30">
			...
			<div class="close" >
				<a href="<?php echo U('User/logout'); ?>" id="logout" style="background: #84BD00;">安全退出</a>
